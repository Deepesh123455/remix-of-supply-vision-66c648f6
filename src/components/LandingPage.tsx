...
const metrics = [
  {
    ...
    desc: "AI demand predictions vs actuals",
    decimals: 0,
  },
  {
    value: 47,
    ...
    desc: "Across all regions and formats",
    decimals: 0,
  },
  {
    value: 28,
    ...
    desc: "Average across our customer base",
    decimals: 0,
  },
  {
    value: 11,
    suffix: "",
    label: "Issues Resolved by AI Daily",
    desc: "Automated decisions per store per day",
    decimals: 0,
  },
];
